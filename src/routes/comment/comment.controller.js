...
export class CommentController {
  ...
  createComment = async (req, res, next) => {
    try {
      ...
      const createComment = await this.commentservice.createComment(cardId, commentContent);
  ...
  updateComment = async (req, res, next) => {
    try {
      ...
      const newComment = await this.commentservice.updateComment(cardId, commentId, commentContent);
